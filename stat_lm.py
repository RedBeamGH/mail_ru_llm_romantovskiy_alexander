...
class GenerationConfig:
    def __init__(self, **kwargs):
        ...
        self.max_tokens = kwargs.pop("max_tokens", 128)
...
def construct_model(model_path, train_corpus=None):
    """
    ...
    stat_lm_path = os.path.join(model_path, 'stat_lm.pkl')
    tokenizer_path = os.path.join(model_path, 'tokenizer.pkl')

    if train_corpus:  # train new model
        ...
        stat_lm.train(train_corpus)
        stat_lm.save_stat(stat_lm_path)
    else:
        tokenizer = Tokenizer()
